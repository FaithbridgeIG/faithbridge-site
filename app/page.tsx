...
export default function FaithBridgeComingSoonPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f6f1e8] text-[#3f352e]">
      <div
      ...
      <div className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-[#f6f1e8]/65 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-12">
          <div className="text-sm font-semibold tracking-[0.28em] text-[#32443a]">
            FAITHBRIDGE
          </div>
      ...
      <section className="relative isolate overflow-hidden pt-20">
        <motion.div
          ...
          style={{ y: parallaxY }}
          initial={{ scale: 1.06 }}
          animate={{ scale: [1.06, 1], x: [0, -10, 0], y: [0, -6, 0] }}
          transition={{
            duration: 18,
            ease: 'easeInOut',
            repeat: Infinity,
          ...
          <div className="grid items-end gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            >
              ...
              <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                <a
                  href="#chat"
                  className="rounded-[1rem] bg-[#ecd58d] px-6 py-3.5 text-center font-semibold text-[#32443a] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#f4df98]"
                >
                  Chat With Us
                </a>

                <a
                  href="/review-my-coverage"
                  className="rounded-[1rem] border border-white/25 bg-white/10 px-6 py-3.5 text-center font-semibold text-white backdrop-blur-md transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/15"
                >
                  Review My Coverage
                </a>
              </div>
                ...
                <div className="mt-5 grid gap-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      >
                        <p className="font-serif text-2xl text-[#32443a]">
                          {value}
                        </p>
            ...
            >
              <div className="rounded-[2rem] border border-[#ebe0d3] bg-white/95 shadow-[0_20px_50px_rgba(77,55,38,0.08)] transition-all hover:shadow-[0_28px_60px_rgba(77,55,38,0.12)]">
                <div className="p-7">
                  ...
                  <p className="mt-4 text-[15px] leading-7 text-[#6f665d]">
                    {item.desc}
                  </p>
                </div>
              </div>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.88fr_1.12fr]">
          <div>
            ...
            <p className="mt-6 max-w-md text-lg leading-8 text-[#6f665d]">
              We believe insurance should feel less transactional and more like
              trusted guidance for the people, places, and plans that matter
              most.
            </p>
            ...
            {polaroids.map((item, index) => (
              ...
              >
                ...
                <div className="px-2 pb-2 pt-4 text-center">
                  <h4 className="font-serif text-2xl text-[#32443a]">
                    {item.title}
                  </h4>
      ...
      <section id="chat" className="mx-auto max-w-5xl px-6 pb-20 lg:px-12">
        <div className="rounded-[2.5rem] border border-[#eadfd2] bg-[linear-gradient(180deg,#fffaf4_0%,#f6efe6_100%)] px-8 py-12 text-center shadow-[0_30px_70px_rgba(78,56,39,0.08)]">
          ...
          <h3 className="mt-4 font-serif text-4xl text-[#3f352e] md:text-5xl">
            Start a conversation with FaithBridge.
          </h3>

          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-[#6f665d]">
            Use the chat button on this page to ask about coverage, policy
            reviews, appointments, or getting started.
          </p>
